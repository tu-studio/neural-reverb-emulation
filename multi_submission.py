...
def generate_hyperparams():
    ...
    combined_mse_weight_options = [100, 1000]

    for (n_bands, kernel_size, n_blocks, dilation_growth), use_kl, use_adversarial, use_skips, use_noise, use_residual_stack, use_wn, use_batch_norm, loss_function, activation, combined_mse_weight in itertools.product(
        configurations,
        ...
        loss_function_options, activation_options, combined_mse_weight_options
    ):
        yield n_bands, kernel_size, n_blocks, dilation_growth, use_kl, use_adversarial, use_skips, use_noise, use_residual_stack, use_wn, use_batch_norm, loss_function, activation, combined_mse_weight

def submit_batch_job(n_bands, kernel_size, n_blocks, dilation_growth, use_kl, use_adversarial, use_skips, use_noise, use_residual_stack, use_wn, use_batch_norm, loss_function, activation, combined_mse_weight):
    env = {
        **os.environ,
